...
CREATE TABLE PATIENT(
	Pid			VARCHAR(30)			NOT NULL, --varchar is variable characters and the 30 in parentheses is the limit
	Fname		VARCHAR(30)			NOT NULL,--null will not allow for empty spaces
	Minit		CHAR,
